...
export default function ProductListItem(props) {
  return (
    <div id={props.productId} onClick={props.setViewDetail} style={{ cursor: 'pointer' }} className="d-flex flex-row align-items-center h-45 col-md-3 mb-4 mx-4 shadow bg-white">
