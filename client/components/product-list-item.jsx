...
export default function ProductListItem(props) {
  return (
    <div id={props.productId} onClick={props.setViewDetail} style={{ cursor: 'pointer' }} className="d-flex flex-row h-45 col-lg-3 col-md-9 mb-4 mx-4 shadow bg-white">
      <div className="list-item d-flex select vw-100 vh-100 align-items-center">
